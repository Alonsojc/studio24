...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Desktop sidebar */}
      <aside className="hidden lg:flex fixed left-0 top-0 h-full w-[260px] bg-[#0a0a0a] text-white flex-col z-50">
        {navContent}
      </aside>
    </>
  );
