...
export function getSeedEgresos(proveedorIds: string[]): Egreso[] {
  return [
    { id: uuid(), fecha: '2026-01-05', descripcion: 'Suscripción Canva Pro', categoria: 'programas', subcategoria: 'Canva', proveedorId: '', monto: 129, iva: 0, montoTotal: 129, formaPago: 'tarjeta', factura: false, numeroFactura: '', notas: '', createdAt: '2026-01-05T10:00:00Z' },
    ...
    { id: uuid(), fecha: '2026-02-01', descripcion: 'Suscripción Adobe Photoshop', categoria: 'programas', subcategoria: 'Photoshop', proveedorId: '', monto: 232, iva: 37.12, montoTotal: 269.12, formaPago: 'tarjeta', factura: true, numeroFactura: 'ADB-2026-02', notas: 'Mensual', createdAt: '2026-02-01T10:00:00Z' },
    ...
    { id: uuid(), fecha: '2026-04-01', descripcion: 'Suscripción Canva Pro abril', categoria: 'programas', subcategoria: 'Canva', proveedorId: '', monto: 129, iva: 0, montoTotal: 129, formaPago: 'tarjeta', factura: false, numeroFactura: '', notas: '', createdAt: '2026-04-01T10:00:00Z' },
...
export function getSeedIngresos(clienteIds: string[]): Ingreso[] {
  return [
    ...
    { id: uuid(), fecha: '2026-02-14', clienteId: clienteIds[2] || '', descripcion: 'Bordado personalizado en chamarra', concepto: 'solo_bordado', monto: 450, iva: 0, montoTotal: 450, formaPago: 'efectivo', factura: false, numeroFactura: '', notas: 'Nombre y diseño de rosas', createdAt: '2026-02-14T10:00:00Z' },
    ...
    { id: uuid(), fecha: '2026-03-12', clienteId: clienteIds[2] || '', descripcion: 'Diseño de logo para bordado', concepto: 'diseno', monto: 800, iva: 0, montoTotal: 800, formaPago: 'efectivo', factura: false, numeroFactura: '', notas: 'Diseño desde cero', createdAt: '2026-03-12T10:00:00Z' },
    ...
    { id: uuid(), fecha: '2026-04-12', clienteId: clienteIds[2] || '', descripcion: 'Reparación de bordado en vestido', concepto: 'reparacion', monto: 350, iva: 0, montoTotal: 350, formaPago: 'efectivo', factura: false, numeroFactura: '', notas: '', createdAt: '2026-04-12T10:00:00Z' },
  ];
}

export function getSeedRecurrentes(): EgresoRecurrente[] {
  return [
    { id: uuid(), descripcion: 'Suscripción Canva Pro', categoria: 'programas', subcategoria: 'Canva', proveedorId: '', monto: 129, formaPago: 'tarjeta', factura: false, diaDelMes: 1, activo: true, createdAt: '2026-01-01T10:00:00Z' },
    { id: uuid(), descripcion: 'Suscripción Adobe Photoshop', categoria: 'programas', subcategoria: 'Photoshop', proveedorId: '', monto: 232, formaPago: 'tarjeta', factura: true, diaDelMes: 1, activo: true, createdAt: '2026-01-01T10:00:00Z' },
...
export function getSeedProductos(): Producto[] {
  ...
  return [
    ...
    // Servicios
    { id: uuid(), nombre: 'Diseño de logo', categoria: 'servicio', precio: 500, activo: true, createdAt: now },
    { id: uuid(), nombre: 'Digitalización de diseño', categoria: 'servicio', precio: 350, activo: true, createdAt: now },
  ];
}
